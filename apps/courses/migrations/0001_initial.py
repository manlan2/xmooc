    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[(b'cj', '\u521d\u7ea7'), (b'zj', '\u4e2d\u7ea7'), (b'gj', '\u9ad8\u7ea7')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download', models.FileField(max_length=150, upload_to=b'course/resource/%Y/%m', verbose_name='\u8d44\u6e90\u6587\u4ef6')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
